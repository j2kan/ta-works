...
1. [Go on password reset](https://team4.uwaterloo.ca/taform/password_reset)
...
2. [Go on password change](https://team4.uwaterloo.ca/taform/password_change)
...
3. [Go on prod and login](https://team4.uwaterloo.ca/login/)
